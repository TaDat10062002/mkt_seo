...
@ApiTags('Company') @UseFilters(DomainExceptionFilter) @Controller('companies')
export class CompanyController {
  ...
  @Patch(':id') update(@Param('id',ParseObjectIdPipe) id:string,@Body() dto:UpdateCompanyDto) { return this.service.update(id,dto); }
