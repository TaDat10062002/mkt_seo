...
@ApiTags('Keyword') @UseFilters(DomainExceptionFilter) @Controller('keywords')
export class KeywordController {
  constructor(private readonly service: KeywordService) {}
  @Post() create(@Body() dto: CreateKeywordDto) { return this.service.create(dto); }
  ...
  @Patch(':id') update(@Param('id',ParseObjectIdPipe) id:string,@Body() dto:UpdateKeywordDto) { return this.service.update(id,dto); }
