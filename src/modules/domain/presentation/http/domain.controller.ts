...
@ApiTags('Domain') @UseFilters(DomainExceptionFilter) @Controller('domains')
export class DomainController {
  constructor(private readonly service: DomainService) {}
  @Post() create(@Body() dto: CreateDomainDto) { return this.service.create(dto); }
  ...
  @Patch(':id') update(@Param('id',ParseObjectIdPipe) id:string,@Body() dto:UpdateDomainDto) { return this.service.update(id,dto); }
